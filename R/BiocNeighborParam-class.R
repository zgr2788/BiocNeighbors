...
#' There are currently 10 concrete subclasses in \pkg{BiocNeighbors}:
#' \describe{
...
#' \item{\code{\link{MlpackLshParam}}:}{Approximate nearest-neighbor search with mlpack locality-sensitive hashing.}
